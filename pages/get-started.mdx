...
#### [Install the package](https://www.npmjs.com/package/mavi)

`npm install -g mavi`

#### mavi.config

To start mavi server, you must to define your configurations. Create a `mavi.config.js` file in your project root like below:
